...
{
    public partial class AddedMedicamentAndPrescriptionMedicamentTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Prescription_Medicament_IdMedicament", x => x.IdMedicament);
                    table.ForeignKey(
